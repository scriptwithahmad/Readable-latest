  ...
  return (
    <>
      <div className=" flex items-center gap-4">
        <div className="bg-[#DAF6E9] p-8 rounded-lg flex items-center justify-center gap-5 w-full">
          <div className=" w-full">
            <h2 className="text-green-800 text-2xl font-semibold">
              Welcome Back 👋 <span className="block">Muhammad Ahmad</span>
            </h2>
          ...
          >
            <SwiperSlide data-hash="slide1">
              <img
                alt="image Here"
                className=" relative"
                src="/images/slider/s1.webp"
              />
              <div className="absolute left-0 bottom-0 bg-gradient-to-t from-slate-950 via-gray-900 text-left px-4 py-6">
                <span className="text-xs font-semibold text-green-600">
                  FEATURED APP
                </span>
                <h1 className=" font-semibold text-white/90 py-1 text-[18px]">
                  Explore VS Code Extentions
                </h1>
                <p className="line-clamp-1 text-sm text-white/70">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Beatae earum, aspernatur aliquam molestias consequatur dolores
                  vitae maxime delectus repellat.
                </p>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide data-hash="slide2">
              <img
                alt="image Here"
                className=" relative"
                src="/images/slider/s3.webp"
              />
              <div className="absolute left-0 bottom-0 bg-gradient-to-t from-slate-950 via-gray-900 to-gray-800/5 text-left px-4 py-6">
                <span className="text-xs font-semibold text-green-600">
                  FEATURED APP
                </span>
                <h1 className=" font-semibold text-white/90 py-1 text-[18px]">
